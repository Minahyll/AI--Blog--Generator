...
const Blog = () => {
  ...
  res.data.success
   ? setData(res.data.blog) : toast.error(res.data.message)
   } catch (error) {
  ...
  return  data ? (
    ...
    <div className='text-center mt-20 text-gray-600'>
      ...
      <p className='inline-block py-1 px-4 rounded-full my-6 border text-sm border-primary/35 bg-blue-50 font-medium text-blue-700'>Michael Brown</p>
    </div>
    <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
      ...
      <div className='max-w-3xl mx-auto'> 
        ...
        gap-4 max-w-lg'>
           ...
           <button type="submit" className='bg-blue-700 text-white rounded p-2
